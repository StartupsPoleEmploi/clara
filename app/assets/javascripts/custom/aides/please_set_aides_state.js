clara.js_define("please_set_aides_state", {
  ...
  _extract_from_state: function(the_initial_state) {
    aids_eligibles = _.defaultTo(
                          _.get(the_initial_state, "eligibles_zone.eligibles.aids"), 
                          []);
    aids_uncertains = _.defaultTo(
                          _.get(the_initial_state, "uncertains_zone.uncertains.aids"), 
                          []);
