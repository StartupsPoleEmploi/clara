...
feature 'Search for aids' do 
  ...
  def create_nominal_schema
    ...
    r_more_than_18 = create(:rule, variable: v_age, operator_type: :more_than, value_eligible: '18', kind: "simple")
    r_more_than_19 = create(:rule, variable: v_age, operator_type: :more_than, value_eligible: '19', kind: "simple")
    r_more_than_20 = create(:rule, variable: v_age, operator_type: :more_than, value_eligible: '20', kind: "simple")
    r_more_than_21 = create(:rule, variable: v_age, operator_type: :more_than, value_eligible: '21', kind: "simple")
    r_less_than_18 = create(:rule, variable: v_age, operator_type: :less_than, value_eligible: '18', kind: "simple")
    r_eqal_than_18 = create(:rule, variable: v_age, operator_type: :eq, value_eligible: '18', kind: "simple")
    r_less_or_eq_18 = create(:rule, variable: v_age, operator_type: :less_or_equal_than, value_eligible: '18', kind: "simple")
