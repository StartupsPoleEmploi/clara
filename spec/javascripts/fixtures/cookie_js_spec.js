...
describe('cookies.js', function() {
  ...
  describe('forbid_navigation', function() {
    ...
    it('Should check forbid_all when you click on forbid_navigation and that forbid_statistic is checked', function() {
      //given
  ...
  describe('forbid_statistic', function() {
    ...
    it('Should check forbid_all when you click on forbid_statistic and that forbid_navigation is checked', function() {
      //given
