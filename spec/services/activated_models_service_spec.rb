...
"all_contracts"=>
  [{"id"=>1,
   ...
   {"id"=>2,
    ...
    "business_id"=>"b2"}],
"all_rules" => [{
  "id"=>"ID_OF_r_composed_be_an_adult2",
...
{"id"=>"ID_OF_r_adult_and_qpv_used",
  ...
  "description"=>nil,
  "value_ineligible"=>nil,
  "slave_rules"=>[{"id"=>"EXISTING"}, {"id"=>"EXISTING"}]}, 
{"id"=>"ID_OF_r_adult_unused",
  "name"=>"r_adult_unused",
  "value_eligible"=>"18",
  "operator_type"=>"more_than",
  "composition_type"=>nil,
