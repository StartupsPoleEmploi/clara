...
module Api
  module V1
    class ApiAidesController < Api::V1::ApiController
      ...
      def filters
        _track_api_call("/api/v1/filters", _tracked(current_api_user))
      ...
      def need_filters
        _track_api_call("/api/v1/need_filters", _tracked(current_api_user))
      ...
      def detail
        _track_api_call("/api/v1/aids/detail/:aid_slug", _tracked(current_api_user))
      ...
      def eligible
        _track_api_call("/api/v1/aids/eligible", _tracked(current_api_user))
      ...
      def ineligible
        _track_api_call("/api/v1/aids/ineligible", _tracked(current_api_user))
        api_asker = ApiAskerService.new(english_asker_params).to_api_asker
        api_filters = ApiFilters.new(filters: filters_param)
        api_need_filters = ApiNeedFilters.new(filters: need_filters_param)
        api_custom_filters = ApiCustomFilters.new(filters: custom_filters_param)
      ...
      def uncertain
        _track_api_call("/api/v1/aids/uncertain", _tracked(current_api_user))
        api_asker = ApiAskerService.new(english_asker_params).to_api_asker
        api_filters = ApiFilters.new(filters: filters_param)
        api_need_filters = ApiNeedFilters.new(filters: need_filters_param)
        api_custom_filters = ApiCustomFilters.new(filters: custom_filters_param)
