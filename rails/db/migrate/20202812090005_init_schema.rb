class InitSchema < ActiveRecord::Migration[6.0]
  def up
    ...
    create_table "aids", id: :serial do |t|
      t.string "name"
      t.text "what"
      t.datetime "created_at", null: false
    ...
    create_table "aids_filters", id: false do |t|
    ...
    create_table "compound_rules", id: :serial do |t|
      t.integer "rule_id"
    ...
    create_table "rules", id: :serial do |t|
      t.string "name"
      t.string "value_eligible"
    ...
    create_table "variables", id: :serial do |t|
      t.string "name"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.text "description"
